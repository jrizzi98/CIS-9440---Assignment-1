...
3. Modeling - Script creating fact and dimension tables with surrogate key. Modeling done with AWS Postgres connections using python. New scripts posted and updated from parts 1 and 2 to iclude Modeling. Lucid Chart Data Model documented showing the fact table and the dimension tables included as well.
